/* @ts-self-types="./openmatl_core.d.ts" */
...
export class WasmEngine {
    ...
    write_file(name, content) {
        ...
        wasm.wasmengine_write_file(this.__wbg_ptr, ptr0, len0, ptr1, len1);
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('openmatl_core_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
